...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pn,depthTest:!1,depthWrite:!1})}function Oa(){return new an({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Js(),fragmentShader:`
		...
		`,blending:pn,depthTest:!1,depthWrite:!1})}function Ba(){return new an({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Js(),fragmentShader:`
...
`)}function md(i,e){let t;switch(e){case Ml:t="Linear";break;case Sl:t="Reinhard";break;case El:t="Cineon";break;case Tl:t="ACESFilmic";break;case Al:t="AgX";break;case bl:t="Neutral";break;case yl:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const rr=new O;function _d(){Ve.getLuminanceCoefficients(rr);const i=rr.x.toFixed(4),e=rr.y.toFixed(4),t=rr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function Ad(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===ro?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Qo?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===jt&&(e="SHADOWMAP_TYPE_VSM"),e}function bd(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ai:case oi:e="ENVMAP_TYPE_CUBE";break;case _r:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Rd(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case oi:e="ENVMAP_MODE_REFRACTION";break}return e}function wd(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case so:e="ENVMAP_BLENDING_MULTIPLY";break;case vl:e="ENVMAP_BLENDING_MIX";break;case xl:e="ENVMAP_BLENDING_ADD";break}return e}function Cd(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Pd(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Ad(t),c=bd(t),h=Rd(t),f=wd(t),d=Cd(t),m=gd(t),v=vd(s),M=r.createProgram();let p,u,b=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Ei).join(`
`)),a=Hs(a),a=Za(a,t),a=$a(a,t),o=Hs(o),o=Za(o,t),o=$a(o,t),a=ja(a),o=ja(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
void main() {
    ...
    `,blending:Qr,transparent:!0,depthWrite:!1}),n=new Gt(e,t);return n.position.set(0,Ct/2,0),n.renderOrder=1.5,xn.add(n),n}let io=0;function Wo(i){requestAnimationFrame(Wo);const e=(i-io)/1e3;io=i;let n=zo*e*ap;for(;n>=1;){const a=Math.floor(Qn);for(let o of fi){const l=o.actualChannel,c=o.mesh.geometry.attributes.position.array,h=(Ti+a)*Ho+l,f=Vs[h]*o.amplitudeScale;c[a*3+1]=o.yOffset+f}Qn++,n--,Qn>=kt&&(Qn=0,Ti+=kt,Ti+kt>Gs&&(Ti=0))}for(let a of fi)a.mesh.geometry.attributes.position.needsUpdate=!0;const s=Qn/(kt-1)*gn;yi.position.x=s,Nn&&(Nn.position.x=s),ti.render(xn,Qt)}async function pp(){up(),await fp(),kt=Math.floor(op*zo),console.log("Sweep sample count:",kt),Ti=0,Qn=0,Go(),ko(),Wo(0)}pp();
